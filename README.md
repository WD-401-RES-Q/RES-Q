...
The system includes 5 pre-configured admin accounts - all with admin role:

- **admin1** - ResQ@2026!Admin1
- **admin2** - ResQ@2026!Admin2
- **admin3** - ResQ@2026!Admin3
- **admin4** - ResQ@2026!Admin4
- **admin5** - ResQ@2026!Admin5
...
3. **Log in with any admin account**

4. **Access the admin dashboard:**
   You'll be redirected to \http://localhost:4200/admin/dashboard\
...
The mobile app includes 5 pre-configured semi-admin accounts with role \semi-admin\:

- **semiadmin1** - Password: \semi1234\ - Role: semi-admin
- **semiadmin2** - Password: \semi1234\ - Role: semi-admin
- **semiadmin3** - Password: \semi1234\ - Role: semi-admin
- **semiadmin4** - Password: \semi1234\ - Role: semi-admin
- **semiadmin5** - Password: \semi1234\ - Role: semi-admin

### Semi-Admin Role Permissions

Semi-admins can:
- Bypass the approval process (no pending_users collection check)
- Access the semi-admin dashboard
- Perform semi-admin specific tasks
...
- Retry logic with resend capability

### Admin Dashboard 
- Account approval management
- Pending/Approved/Rejected account tabs
- One-click approve/reject functionality
- Admin authentication with session persistence

### Semi-Admin System 
- Pre-configured semi-admin accounts
- Bypass approval workflow
- Dedicated semi-admin features
...
- [ ] Generate SHA-1 certificate for Android
- [ ] Configure Firebase Console with app settings
- [ ] Test user registration flow
- [ ] Test OTP verification
- [ ] Test admin approval workflow
- [ ] Test semi-admin login
- [ ] Test web admin dashboard
- [ ] Verify all security rules are in place
...
##  PRODUCTION READY FEATURES
 ...
 Semi-admin bypass functionality
 Secure login authentication
 Role-based access control
 Firestore database integration
 Angular web administration dashboard
 Complete audit trail and logging
 Security rules and data validation

---

**Your RES-Q platform is now fully documented and production-ready! **
